...
package moe.furryverse.tails.server.annotation;
...
import moe.furryverse.tails.common.exception.UnauthorizationException;
import moe.furryverse.tails.common.message.Message;
import moe.furryverse.tails.common.security.Permission;
import moe.furryverse.tails.server.service.AccessService;
...
public @interface PermissionCheck {
    ...
    public class AccessChecker {
        ...
        @SneakyThrows
        @Around(value = "@annotation(moe.furryverse.tails.server.annotation.PermissionCheck)")
