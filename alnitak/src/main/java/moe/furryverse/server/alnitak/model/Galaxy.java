 ...
 * @param viewer       未公开状态下可以查看帖子的用户
 * @param collaborator 可以编辑帖子的用户
 * @param isPublic     是否公开
...
public record Galaxy(
        ...
        @Field("galaxy_id") @NotNull @Id String galaxyId,
        @Field("cluster_id") @NotNull String clusterId,
        @Field("title") @NotNull String title,
        @Field("title_edited") @NotNull String titleEdited,
        @Field("background") @Nullable String background,
        @Field("nucleus") @NotNull List<String> nucleus,
        ...
        @Field("is_reviewing") boolean isReviewing,
        @Field("is_archived") boolean isArchived
) {
}
